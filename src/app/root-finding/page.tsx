...
export default function RootFindingPage() {
  const methods = getMethodsByCategory('root-finding');
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="mb-8 animate-fadeInUp">
        ...
        <div className="flex items-center gap-3 mt-2">
          ...
          <h1 className="text-3xl font-bold gradient-text">Raíces de Ecuaciones</h1>
        </div>
        <p className="mt-2" style={{ color: 'var(--text-secondary)' }}>
          Métodos para encontrar los valores de x donde f(x) = 0. Desde métodos cerrados (bisección)
          hasta métodos abiertos de convergencia rápida (Newton-Raphson).
        </p>
      </div>
