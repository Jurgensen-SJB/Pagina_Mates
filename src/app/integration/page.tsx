...
export default function IntegrationPage() {
  const methods = getMethodsByCategory('integration');
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="mb-8 animate-fadeInUp">
        ...
        <div className="flex items-center gap-3 mt-2">
          ...
          <h1 className="text-3xl font-bold gradient-text-secondary">Integración Numérica</h1>
        </div>
        <p className="mt-2" style={{ color: 'var(--text-secondary)' }}>
          Métodos para aproximar el valor de integrales definidas usando reglas de cuadratura.
          Desde el Trapecio hasta Simpson 3/8.
        </p>
      </div>
